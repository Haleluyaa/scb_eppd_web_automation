...
*** Test Cases ***
Check SAP display details on Manage CNDN view detail
    [Tags]    Ready    Regression    Web    High 
    [Documentation]    To verify that SAP display details on Manage CNDN view detail is display correctly as database
